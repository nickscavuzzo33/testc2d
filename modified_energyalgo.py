...
logging.basicConfig(filename='energy_algo.log', level=logging.INFO, 
...
# Assuming 'results' is the variable that holds the computation output
try:
    # Modify this part based on the actual structure of 'results'
    with open('results.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(results)
    logging.info("Results successfully saved to results.csv")
except Exception as e:
    logging.error("Error in saving results: " + str(e))
